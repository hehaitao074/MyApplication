...
/**
 * Created by hehaitao01 on 2017/3/27.
 */

public class FanImgAdapter extends BaseAdapter<String> {

    public FanImgAdapter(Context mContext, List<String> datas) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ).inflate(R.layout.layout_fan_item_card_img, parent,
...
//            ImageOptions imageOptions = new ImageOptions.Builder().setRadius(2).setUseMemCache(true).setFadeIn(true).build();
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            img = (ImageView) itemView.findViewById(R.id.fan_img_item_card);
        }
    }
}
