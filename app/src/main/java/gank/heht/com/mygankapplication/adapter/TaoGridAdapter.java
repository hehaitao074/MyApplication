...
public class TaoGridAdapter extends BaseAdapter <TaoNvListBean.ShowapiResBodyBean.PagebeanBean.ContentlistBean>{

    public TaoGridAdapter(Context mContext, List<TaoNvListBean.ShowapiResBodyBean.PagebeanBean.ContentlistBean> datas) {
