...
import gank.heht.com.mygankapplication.utils.OnDragVHListener;
import gank.heht.com.mygankapplication.utils.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<NewsTypeInfo> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    //编辑完成事件
    private OnFinishChannelEditListenner onFinishChannelEditListenner;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<NewsTypeInfo> mMyChannelItems, List<NewsTypeInfo> mOtherChannelItems) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        NewsTypeInfo item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        NewsTypeInfo item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        NewsTypeInfo item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    private void cancelEditMode(RecyclerView parent) {
        ...
        onFinishChannelEditListenner.onChannelEditFinished();
    }
    ...
    public interface OnFinishChannelEditListenner{
        void onChannelEditFinished();
    }

    public void setOnFinishChannelEditListenner(OnFinishChannelEditListenner onFinishChannelEditListenner) {
        this.onFinishChannelEditListenner = onFinishChannelEditListenner;
    }
