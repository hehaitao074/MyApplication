...
public class GankGridAdapter extends BaseAdapter <InfoBean.ResultsBean>{
    ...
    public void onBindViewHolder( RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            //加载图片
            ImageOptions imageOptions = new ImageOptions.Builder().setRadius(2).setUseMemCache(true).setFadeIn(true).setSize(300, 400).setFailureDrawableId(R.mipmap.ic_avatar1).build();
